package com.iyyxx.generator.common;
 ...
 * @date: 2022/10/12/0012 10:31:54
 **/
public class MysqlGenerator {

    public static final String DATABASE_URL = "jdbc:mysql://192.168.20.145:3306/mptest" +
    ...
    public static final String OUT_PUT_PATH = "/MybatisPlusTest/src/main/java";
    public static final String TEMPLATES_MAPPER_XML_PATH = "/templates/mapper.xml.ftl";
    public static final String XML_PATH = "/MybatisPlusTest/src/main/resources/mapper/";
    public static final String XML_POSTFIX = "Mapper";

    public static final String AUTHOR = "林智辉";
    public static final String PARENT_PACKAGE = "com.iyyxx.generator";
